/// @description tmc_segment_intersect_plane(segment Segment, vect3 PlanePoint, vect3 PlaneNormal, vec3 out_IntersectPoint)
/// @param segment Segment
/// @param  vect3 PlanePoint
/// @param  vect3 PlaneNormal
/// @param  vec3 out_IntersectPoint
/*
