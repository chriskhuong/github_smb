...
attack_key_analog		= inputdog_analog("attack_key_analog",		playerSlot);	//keyboard_check_pressed(ord("V")) || mouse_check_button(mb_right);  //change this variable to 'shoot' //come back to this
