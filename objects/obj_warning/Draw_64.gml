...
for(i = 0; i < stripeNum + 2; i++)
	{
		draw_sprite_ext(spr_survival_popup_bg, 1, stripeX + ((i-1) * stripeWidth), stripe1Y, 1, 2, image_angle, image_blend, stripeAlpha);
		draw_sprite_ext(spr_survival_popup_bg, 1, stripeX + ((i-1) * stripeWidth), stripe2Y, 1, 2, image_angle, image_blend, stripeAlpha);
	}
/*
{
