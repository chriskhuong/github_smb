...
//fire settings
part_type_sprite(particle_Explosion_system, spr_effect_Explosion, 0, 0, 1); 
part_type_size(particle_Explosion_system, 0.4, 0.8, 0, 0); 
part_type_colour2(particle_Explosion_system, c_orange, c_red); 
part_type_alpha3(particle_Explosion_system, 1, 0.5, 0); 
part_type_speed(particle_Explosion_system, 0.4, 0.8, 0, 0); 
part_type_direction(particle_Explosion_system, 0, 359, 0, 10); 
part_type_orientation(particle_Explosion_system, 0, 359, 0, 0, 0); 
part_type_life(particle_Explosion_system, 5, 10); 
